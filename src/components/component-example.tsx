...
import { Plus, Bluetooth, DotsThreeCircleVertical, File, Folder, FolderOpen, Code, DotsThreeCircle, MagnifyingGlass, FloppyDisk, DownloadSimple, Eye, Layout, Palette, Sun, Moon, Monitor, User, CreditCard, Gear, Keyboard, Globe, Bell, Envelope, Shield, Question, FileText, SignOut } from "@phosphor-icons/react"

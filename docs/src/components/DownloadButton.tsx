	...
	return (
		<div className="flex flex-col items-start gap-2">
			<a
				...
				target="_blank"
				className="inline-flex items-center gap-2 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90"
			>
